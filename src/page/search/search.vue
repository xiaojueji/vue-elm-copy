        ...
        >
          ...
          <section class="item_right">
            <div class="item_right_text">
              ...
              <p>{{ item.delivery_feee }} 元起送 / 距离{{ item.distance }}</p>
            </div>
  ...
  methods: {
    ...
    async searchTarget() {
      ...
      if (history) {
        ...
        if (!checkrepeat) this.searchHistory.push(this.searchValue);
      } else {
