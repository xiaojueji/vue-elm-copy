      ...
      <div class="sort_item" :class="{ choose_type: sortBy === 'food' }">
        <div class="sort_item_container" @click="chooseType('food')">
          <div class="sort_item_border">
            <span
              :class="{ category_title: sortBy === 'food' }"
            >
              {{ foodTitle }}
            </span>
            <svg
            ...
            <section class="category_left">
              <ul>
                ...
                >
                  <section>
                    <img
                      :src="imgBaseUrl + subImgUrl(item.image_url)"
                      v-if="index"
                      class="category_icon"
                    />
                    <span>{{ item.name }}</span>
        ...
        <transition name="showlist">
          <section v-show="sortBy === 'activity'" class="sort_detail_type filter_container">
            ...
            <footer class="confirm_filter">
              <div
                class="clear_all filter_button_style"
                @click="clearAll"
              >
                清空
              </div>
...
export default {
  ...
  methods: {
    ...
    selectDeliveryMode (id) {
      ...
      // delivery_mode 为当前已有值时，清空所选项，并且filterNum减一
